import * as httpProxy from '../lib/es-proxy/passes/web-outgoing'
...
describe('lib/es-http-proxy/passes/web-outgoing.js', function () {
  describe('#setRedirectHostRewrite', function () {
    beforeEach(function() {
      ...
      this.proxyRes = { statusCode: 301, headers: { location: 'http://backend.com/' } }
      this.options = { target: 'http://backend.com' }
    })
  ...
  describe('#writeHeaders', function() {
    var proxyRes = { headers: { hey: 'hello', how: 'are you?' } }

    var res = { setHeader: function(k, v) {
        this.headers[k] = v
      }, headers: {} }
  ...
  describe('#removeChunked', function() {
    var proxyRes = { headers: { 'transfer-encoding': 'hello' } }
