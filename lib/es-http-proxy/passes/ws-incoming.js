...
function XHeaders(req, socket, options) {
  ...
  xValues.forEach(function (header) {
...
function stream(req, socket, options, head, server, clb) {
  ...
  var proxyReq = (common.isSSL.test(options.target.protocol) ? _https2.default : _http2.default).request(common.setupOutgoing(options.ssl || {}, options, req));
  ...
  proxyReq.on('upgrade', function (proxyRes, proxySocket, proxyHead) {
    ...
    //
    socket.write((0, _keys2.default)(proxyRes.headers).reduce(function (head, key) {
